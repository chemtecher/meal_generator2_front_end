    ...
    return (
        <main className="about_us--main">
            ...
            <p className="about_us--stats">
                The idea behind this app is to help users reduce food waste by giving them recipe ideas of ingredients they already have at home.
                ...
                expensive to the consumer- about $160 billion in spoiled foods annually. We hope that with the web application, not only is the user able to reduce the amount of food waste at home, but that it also helps 
                them save money, while learning to have fun in the kitchen and trying out different recipes!
            </p>
